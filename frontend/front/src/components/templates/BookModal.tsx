...
export const BookModal: VFC<BookModalProps> = memo((props) => {
  ...
  return (
    <>
      {showModal ? (
        <>
          <div className="justify-center min-h-full items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none animate-fade-in-up">
