...
def make_news_for_demo():
    ...
    news_data = {
        ...
        "news2": {
            "title": "韓国で歴代最大規模の横領…被害１８０億円　1/6 14:15更新",
            "summary": "韓国の上場企業で、「歴代最大規模」となる被害額１８０億円あまりの横領事件が起きました。逮捕された職員は８５０キロもの金塊を買い入れていました。",
            "link": "http://www.news24.jp/articles/2022/01/06/101007920.html",
        },
        "news3": {
            "title": "北“極超音速ミサイル”７００キロ先に命中　1/6 12:47更新",
            "summary": "北朝鮮メディアは、極超音速ミサイルの発射実験を５日行ったと報じました。５日、発射された飛翔体を指すとみられます。",
            "link": "http://www.news24.jp/articles/2022/01/06/101007876.html",
        },
        "news4": {
